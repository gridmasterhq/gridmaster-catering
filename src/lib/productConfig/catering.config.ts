...
const cateringConfig: ProductConfig = {
  ...
  labels: {
    ...
    ai_template_builder_heading: 'AI Template Builder',
    ai_template_builder_subtitle:
      'Describe your event and AI builds a reusable template',
    ai_template_mode_freeform: 'Describe it myself',
    ai_template_mode_guided: 'Ask me questions',
    ai_template_input_placeholder: 'Type your message...',
    ai_template_api_error: 'Something went wrong. Please try again.',
    ai_template_retry: 'Retry',
    ai_template_ready_heading: 'Your template is ready',
    ai_template_save_button: 'Save to My Templates',
    ai_template_saved_confirmation: 'Saved to My Templates',
    ai_template_use_now_button: 'Use This Template Now',
    ai_template_start_over: 'Start over',
  ...
  staffProfileTabs: [
    {
      ...
      sublabel1: 'Events · Ratings',
      sublabel2: 'Milestones',
    },
    {
      id: 'certifications',
      label: 'Certifications',
      componentKey: 'StaffProfileCertificationsTab',
      sublabel1: 'Certs · Courses',
      sublabel2: 'Grades',
    },
    {
      id: 'availability',
    ...
    },
    {
      ...
      sublabel1: 'Private notes',
      sublabel2: '(coordinator only)',
    },
  ],
  terminology: {
    staff: 'Staff',

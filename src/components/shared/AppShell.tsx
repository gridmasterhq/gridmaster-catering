  ...
  return (
    <div className="min-h-screen flex flex-col" style={themeVars}>
      <header className="fixed top-0 left-0 right-0 z-30 flex h-12 w-full">
        <section className="flex flex-1 items-center gap-6 bg-[var(--shell-brand-red)] px-20">
          <button
            type="button"
        ...
        <section className="flex flex-1 items-center justify-end gap-6 bg-[var(--shell-brand-navy)] px-20">
          <span className="text-sm font-semibold tracking-wide text-white uppercase">
            {labels.calendar}
          </span>
          <button

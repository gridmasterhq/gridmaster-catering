  ...
  return (
    <div className="min-h-screen flex flex-col" style={themeVars}>
      <header className="fixed top-0 left-0 right-0 z-30 flex h-12 w-full">
        <section className="flex flex-1 items-center gap-10 bg-[var(--shell-brand-red)] px-20">
          <button
            type="button"
        ...
        <section className="flex shrink-0 flex-col items-center justify-center bg-white px-4 py-1">
        ...
        <section className="flex flex-1 items-center justify-end gap-10 bg-[var(--shell-brand-navy)] px-20">
          <span className="text-sm font-semibold tracking-wide text-white uppercase">
            {labels.calendar}
          </span>
          <button
